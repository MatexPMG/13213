...
const departureDelay = actualDeparture != null && scheduledDeparture != null
  ...
  : null;
    ...
    for (const trainObj of unified) {
      map.set(trainObj.tripShortName, trainObj);
    }
    ...
    console.log("ÖBB Railjets updated:", unified.length);
